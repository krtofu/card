...
export function defineCharacterCards(
  ...
  return data.cards.map((card) => {
    ...
    const vsMap: Record<string, string> = {
      "하츠네 미쿠": "MIKU", "미쿠": "MIKU", "카가미네 린": "RIN", "린": "RIN", "카가미네 렌": "LEN", "렌": "LEN",
    ...
    if (originalMap[cleanCharName]) {
      ...
      else if (cleanUnitName.includes("니고") || cleanUnitName.includes("Niigo") || cleanUnitName === "ng" || cleanUnitName === "niigo") suffix = "_n";
